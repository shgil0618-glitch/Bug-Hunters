...
public interface Recipes3Dao {
 ...
 // recipes3 상태 변경
    ...
    //관리자용
    // 관리자용 페이징 + 검색
    List<Recipes3Dto> selectAdminRecipePaged(Map<String,Object> params);
    int countAdminRecipes(Map<String,Object> params);

    // 관리자용 무조건 삭제
    int deleteAdminRecipe(int recipeId);
    int deleteAdminRecipeSteps(int recipeId);
    int deleteAdminRecipeIngredients(int recipeId);
    int deleteAdminRecipeLikes(int recipeId);
}
