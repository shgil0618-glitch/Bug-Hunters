...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  <div class="container-fluid">
	...
	<sec:authorize access="isAuthenticated()">
	      ...
	      <li class="nav-item">
	        <a class="nav-link"    href="${pageContext.request.contextPath}/recipe/mylist">나의 레시피 목록</a>
	      </li>
    	  <li class="nav-item">
    ...
    <sec:authorize   access="isAnonymous()">  <!-- ##  아무나다 접근가능하게 -->
	      ...
	      <li class="nav-item">
	        <a class="nav-link"    href="${pageContext.request.contextPath}/recipe/register">요리 등록</a>
	      </li> 
	      <li class="nav-item">
	        <a class="nav-link"    href="${pageContext.request.contextPath}/recipe/list">요리 목록</a>
	      </li> 
    </ul> 
  </div>
</nav>
